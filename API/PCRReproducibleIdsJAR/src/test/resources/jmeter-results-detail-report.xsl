		...
		<table align="center" class="details" border="0" cellpadding="5"
			...
			<xsl:for-each select="/testResults/*[not(@lb = preceding::*/@lb)]">
				...
				<xsl:variable name="successCount"
					select="count(../*[@lb = current()/@lb][attribute::s='true'])" />
				...
				<tr class="page_details">
					...
					<td colspan="8" bgcolor="#FF0000">
						<div align="center">
							...
							<table bordercolor="#000000" bgcolor="#2674A6" border="0"
				...
				<xsl:for-each select="/testResults/*[@lb = current()/@lb]"><!-- [attribute::s='false']"> -->
					...
					<tr>
 					...
 					<xsl:variable name="message">
						...
						<td
								style="white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-wrap:break-word;font-weight:bold; color:red;font-size:75%">
